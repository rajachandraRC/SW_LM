...
public class BookData {
	//Book stack
	public static String[] booknames = new String[10];//book name
	public static String[] authors = new String[10];//Author
	public static String[] pubdates = new String[10];//Publication date
	public static String[] sumpaginations = new String[10];//Total number of pages
