...
import com.jiaxun.library.users.Admin;
import com.jiaxun.library.users.Student;
import com.jiaxun.library.users.UserFactory;
import com.jiaxun.library.users.user;

public class FactoryMainLibraryUI {

	Bo bo = new Bo();
	

	public static void main(String[] args) {
		//UserFactory ouf = new UserFactory();
		//user obj = ouf.getInstance("S");
		//obj.details();
		FactoryMainLibraryUI ui = new FactoryMainLibraryUI();
